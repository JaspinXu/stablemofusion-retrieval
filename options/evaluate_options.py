...
class TestOptions():
    ...
    def initialize(self):
        ...
        # evaluator
        self.parser.add_argument("--evaluator_dir", type=str, default='/root/autodl-tmp/StableMoFusion/data/pretrained_models', help='Directory path where save T2M evaluator\'s checkpoints')
        self.parser.add_argument("--eval_meta_dir", type=str, default='/root/autodl-tmp/StableMoFusion/data', help='Directory path where save T2M evaluator\'s normalization data.')
        self.parser.add_argument("--glove_dir",type=str,default='/root/autodl-tmp/StableMoFusion/data/glove', help='Directory path where save glove')
